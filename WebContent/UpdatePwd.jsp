	...
	<div class="container">
		<div class="row">
			<div class="categories-breadcrumb">
				...
				<table align="center">
    <form id="form1" action="modipwd" method="post">
    	<tr><th>输入新密码：<input type="password" name="pwd1" id="pwd1"></th></tr>
    	<tr><th>确认新密码：<input type="password" name="pwd2" id="pwd2"></th></tr>
    	<tr><th><input type="button" value="确定" onclick="modi()"/></th></tr>
    </form>
    </table>
			</div>
			<div style="color:red" id="info" align="center">${updateans}</div>
			<div class="divider">
